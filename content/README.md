...
## Bag of Tips' TTRPG Template Vault
> [!kirk|info] Tip
...
### Overview
This vault is designed to house all of your notes for your Worldbuilding, either as a story writer or a TTRPG game master! When I say notes, I mean information about your characters, such as their names, locations, interests, desires, etc. My worldbuilding happens for my TTRPG game, so my personal methodology is to keep the game separate from my notes. I tend keep all my player sheets, monster stat blocks, and items within my virtual tabletop of choice. However, many people choose to bring all this information into their personal vaults, and many have great success with that. It all comes down to personal preference.
...
**This covers the 2024 version of the vault; I have a new video scheduled. However, this should cover the majority of how the vault works.**
...
Well, the nice (and maybe daunting) things about Obsidian is, you get to ultimately choose how you organise your notes! You can either keep everything as it is, or change everything. However, I will cover how I intend the notes to work, and let you decide from there how you want to tackle it.

Previously, I used to organise the notes  where I would give a title, then a prompt. This works, but I have found from talking to many of you that this can be overwhelming. Having a blank space where it invites you write paragraphs can put some people off creating. It's great for people that want to do that type of thing, but sometimes you just need to put down a few words. That's where the new method comes in.

Now, we still have the titles, and the greyed out prompts. However, we now have a bullet point. (Ground-breaking... I know.) However, this is where some psychology comes in. Before, we were left with an empty space, which is usually associated with writing paragraphs. Bad for people that don't want to write a lot! Now we have a bulletpoint, which is normally associated with making short notes. Exactly what we are looking for to make this less overwhelming! 

Now, as I mentioned earlier, Obsidian is great for making your notes your own. It's what sets it apart from other note taking tools made for TTRPGs. You are not set to how I give it to you. So if you want to write in paragraphs, then remove the bullet point and get writing. If you want to do something totally different, then you can do that too. The goal here is to make it as accessible as possible for people, so, if that results in you creating more, then that's a win for me.

Read more about it here: [Reddit](https://www.reddit.com/r/BagOfTips/comments/1pcaf43/how_to_write_more_by_doing_less_ttrpg_template/) / [Ko-fi](https://ko-fi.com/post/Write-More-By-Doing-Less-In-TTRPG-DD-C0C21PJR5N?fromEditor=true)
...
Properties are the driving factor of some of the functionality within our notes. These are a base part of obsidian that allow us to have data we can use. To change these, you can either find the note's properties at the top of each note, or in the side bar. If you like having the properties in your notes, you just need to right click on the properties icon in the left side bar, and close it. If you want to not have them visible in your notes however, you will want to head to Settings > Editor > Properties in document and set it to 'Hidden'.

![[PropertiesExample.png]]
...
<center><iframe width="560" height="315" src="https://www.youtube.com/embed/47gVvg06jNM?si=ZWu9NGP5VjoGDOL1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></center>
...
- **whichParty**
	- Used to specify which one of your parties the note is related to. (Example: a Character note with the property whichParty set to Party A, will display that character is traveling with Party A and display on their Dashboard).
- **summary**
...
- **affiliations**
	- Lets you link a character or location to a Faction. This is used to show an NPCs importance to said faction.
	- This could be expanded to let NPCs be affiliated with other NPCs if you would like.
- **located**
	- This is used to set the location of a note. Such as an NPC within a settlement.
...
#### [[Template - Geographic]]
The geographic template is for recording bodies of the world. It covers their formation, history, notable landmarks, and the secrets, rumours, and legends tied to them.

**Properties:**
- **geographicType**
	- Sets the type of geographic it is. (Example: Continent, Island, Ocean, Subterrane, Floating Island.)

#### [[Template - Region]]
<font color=" #7f7f7f">This is an optional template, use this template if you want to get more details or break down geographics into more manageable chunks.</font>
...
#### [[Template - Area]]
<font color=" #7f7f7f">This is an optional template, use this template if you want to get more details or break down regions into more manageable chunks.</font>
**Properties:**
- **terrain**
...
- **age**
	...
	- This could be changed to a text field and used to estimate the age of a character such as "Child" or "Elder".
- **languages**
...
#### [[Template - Faction]]
The Faction template is for detailing groups such as guilds, cults, companies, or governments. It covers their purpose, structure, history, holdings, and the secrets, rumours, and legends that define them.
...
#### [[Template - Creature]]
If you are writing your own story or home bring your own games you may need to create your own creatures. this template acts as a simple base for you to work from to design your very own creatures and monsters.

- **size**
	- The size of your creature.
- **traits**
	- The traits of your creature.
...
#### BasesCalloutConflictFix
A small piece of css that fixes an issue with bases where when they are in the note, they will not wrap with a callout and be pushed below.
...
#### BetterListSpacing
A small snippet that improves the spacing of lists. It does the following:
1. Moves the points closer to the text above so there is less of a gap.
2. Spaces out the first-level items so it's clearer to read.

#### BiggerInlineTitles
Allows us to increase the size of the inline titles at the top of our notes.
...
Hides the status bar in the bottom left.
...
#### SCallouts
<font color=" #7f7f7f">Depending on which theme you choose, you may want to enable this as it conflicts with the FaS Theme. This is very much where you get to customize your vault.</font>

Callout snippets made by the creator of the ITS theme, allowing us to use callouts such as the infobox in any theme.
...
_Tutorial: https://www.youtube.com/watch?v=EPZApwiOvAI_
...
> > - sailKite (For all their support and wisdom)
